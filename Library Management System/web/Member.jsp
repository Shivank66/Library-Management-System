...
<div class="container cont ">
	...
	<div class="row">
		...
		<div class ="col-md-4 form-group">
			...
			<input type="date" class="input form-control " id="dateR" name="dateR" placeholder="Registration Date">
			</div>
		</div>
		<div class ="col-md-4 form-group">
			<div class="form-group">
			Registration Expiry Date<br>
			<input type="date" class="input form-control " id="dateV" name="dateV">
			</div>
		</div>
		<div class="col-md-2">
		</div>
