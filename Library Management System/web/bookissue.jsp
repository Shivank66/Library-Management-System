   ...
   <input type ="hidden" name="check">
	...
	<div class="row">
		...
		<div class ="col-md-4 form-group">
			<div class="form-group">
			Date of Issue<br>
			<input type="date" class="input form-control " name="dateI"  id="dateI" placeholder="Enter Date Of Issue">
			</div>
		</div>
		<div class ="col-md-4 form-group">
			<div class="form-group">
			Expected Date of Return<br>
			<input type="date" name="dateR" class="input form-control "  value="" id="dateR" placeholder="Enter Date of Issue" >
			</div>
		</div>
		<div class="col-md-2">
		</div>
