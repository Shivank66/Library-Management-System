...
<%
    ...
    //String drop="";
    String alert="";
    String nam1="",nam2="",mobile="",address="";
    int Clerkno=0;//,usertypeno=0;
    ...
    if(!isPostback)
    {
        ...
        Clerk m =new Clerk(session,Integer.parseInt(key));
        Clerkno=Integer.parseInt(request.getParameter("key"));
        nam1= m.getFirstName();
        nam2=m.getLastName();
        mobile=m.getMobile();
    ...
    if(isPostback)
    {
     ...
     Clerk m = new Clerk (session,Clerkno);
      m.setFirstName(nam1);
     m.setLastName(nam2);
     m.setMobile(mobile);
...
<!--!-->
<form action="ClerkUpdate.jsp" method="post">
    <div class="col-sm-12">
            <%=alert%>
        </div>
<div class="container cont ">
	...
	<div class="row">
		...
		<div class=" col-md-8 form-group">
			Clerk no<br>
                        <input type="text" class="input form-control " placeholder="" value="<%=Clerkno%>" id="Clerkno" name="Clerkno" readonly>
			</div>
		<div class="col-md-2">	
